...
class Day9Test {
    ...
    void testGroups3(){
        String input="{{{}}}";
        setInput(input);
        assertEquals(3, getNumberOfGroups());
    }
    @Test
    void testGroups4(){
        String input="{{{},{},{{}}}}";
        setInput(input);
        assertEquals(6, getNumberOfGroups());
    }
    @Test
    void testGroups5() {
        String input="{<{},{},{{}}>}";
    ...
    void testGroups6() {
        ...
        setInput(input);
        assertEquals(5, getNumberOfGroups());
    }
    @Test
    void testScore1() {
        String input="{}";
        setInput(input);
        assertEquals(1, getScore());
    }
    @Test
    void testScore2() {
        String input="{{{}}}";
        setInput(input);
        assertEquals(6, getScore());
    }
    @Test
    void testScore3() {
        String input="{{{},{},{{}}}}";
        setInput(input);
        assertEquals(16, getScore());
    }
    @Test
    void testScore4() {
        String input="{<a>,<a>,<a>,<a>}";
    ...
    void testGarbage2() {
        ...
        setInput(input);
        assertEquals(17, getGarbageSize());
    }
    @Test
    void testGarbage3() {
        String input="<<<<>";
        setInput(input);
        assertEquals(3, getGarbageSize());
    }
    @Test
    void testGarbage4() {
        String input="<{!>}>";
        setInput(input);
        assertEquals(2, getGarbageSize());
    }
    @Test
    void testGarbage5() {
        String input="<!!>";
