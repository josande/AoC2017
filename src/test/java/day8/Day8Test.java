...
class Day8Test {
    ...
    void testA() {
        ...
        assertEquals(1, getHighestPositionValue());
    }
    @Test
    void testB() {
        String input="b inc 5 if a > 1\n" +
                ...
                "c inc -20 if c == 10";
        parseInstructions(input);
        assertEquals(10, getHighestEverPositionValue());
    }
    @Test
    void puzzle() {
        ...
        parseInstructions(input);
        System.out.println("Result Day8(a): "+getHighestEverPositionValue() + " at " +getHighestPositionName() + ".");
        System.out.println("Result Day8(b): "+getHighestEverPositionValue()+" at "+ getHighestEverPositionName() + ".");
    }
}