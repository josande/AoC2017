...
import static day4.Day4.calculateA;
import static day4.Day4.calculateB;
...
class Day4Test {
    ...
    void test1a() {
        ...
        assertEquals(true, calculateA(input));
    }
    @Test
    void test1b() {
        String input="abcde fghij";
        assertEquals(true, calculateB(input));
    }
    @Test
    void test2a() {
        String input="aa bb cc dd aa";
        assertEquals(false, calculateA(input));
    }
    @Test
    void test2b() {
        String input="abcde xyz ecdab";
        assertEquals(false, calculateB(input));
    }
    @Test
    void test3a() {
    ...
    void puzzle() {
        ...
        for (String row : input.split(("\n"))) {
            passA+=calculateA(row)?1:0;
            passB+=calculateB(row)?1:0;
        }
        System.out.println("Result Day4(a): "+passA);
        System.out.println("Result Day4(b): "+passB);
    }
}
